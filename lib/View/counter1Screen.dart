...
class Counter1Screen extends StatelessWidget {
  final String? index;
  Counter1Screen({Key? key, this.index}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text("Value of count on screen 1", style: TextStyle(color: AppColors.textColor,)),
            ...
            ElevatedButton(
              style: ButtonStyle(backgroundColor: MaterialStateProperty.all(AppColors.brown1)),
                onPressed: () => controller.increment("counter1", "1"),
